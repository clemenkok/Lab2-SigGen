...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->dout2 = vlSelf->sinegen__DOT__sineRom2__DOT__rom_array
        [vlSelf->sinegen__DOT__addr2];
    vlSelf->dout1 = vlSelf->sinegen__DOT__sineRom1__DOT__rom_array
        [vlSelf->sinegen__DOT__addr1];
    if (vlSelf->rst) {
        vlSelf->sinegen__DOT__addr2 = 0U;
        vlSelf->sinegen__DOT__addr1 = 0U;
    } else {
        vlSelf->sinegen__DOT__addr2 = (0xffU & (((IData)(vlSelf->sinegen__DOT__addr2) 
                                                 + (IData)(vlSelf->incr2)) 
                                                + (IData)(vlSelf->en)));
        vlSelf->sinegen__DOT__addr1 = (0xffU & (((IData)(vlSelf->sinegen__DOT__addr1) 
                                                 + (IData)(vlSelf->incr1)) 
                                                + (IData)(vlSelf->en)));
    }
}
