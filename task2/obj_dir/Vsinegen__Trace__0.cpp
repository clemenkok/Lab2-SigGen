...
void Vsinegen___024root__trace_chg_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+3,(vlSelf->incr1),8);
    bufp->chgCData(oldp+4,(vlSelf->incr2),8);
    bufp->chgCData(oldp+5,(vlSelf->dout1),8);
    bufp->chgCData(oldp+6,(vlSelf->dout2),8);
    bufp->chgCData(oldp+7,(vlSelf->sinegen__DOT__addr1),8);
    bufp->chgCData(oldp+8,(vlSelf->sinegen__DOT__addr2),8);
}
